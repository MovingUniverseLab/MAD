...
df1 = query_alerts.get_ogle_alerts(2024)
print('Downloaded OGLE alerts from 2024 to database.')
query_alerts.get_kmtnet_alerts(2024)
print('Downloaded KMTNet alerts from 2024 to database.')
